...
chown -R 1000:1000 ./input ./output 2>/dev/null || sudo chown -R 1000:1000 ./input ./output || echo "Note: Could not set ownership. You may need to run: sudo chown -R 1000:1000 ./input ./output"
...
echo "2. Place video files in ./input directory"
echo "3. Run: docker-compose up -d"
echo "4. Check logs: docker-compose logs -f"
echo "5. Health check: curl http://localhost:8080/health"
echo ""
echo "Converted audio files will appear in ./output directory"
